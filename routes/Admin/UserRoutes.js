...
router.patch("/:userId/changepassword",authMiddleware,rolesPermissions("user", "edit"), ChangePassword);
router.get("/userslist",authMiddleware,rolesPermissions("user", "view"), FetchUsers);
router.get("/userslogsfile",  UserLogsFile);
router.get("/userslogs",authMiddleware, rolesPermissions("user", "view"), UserLogs);
