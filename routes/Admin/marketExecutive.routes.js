...
import { addMarketExec, addNominee, editNominee, getMarketExecutive, getMarketExecutiveById, updateMarketExec, uploadMarketExecImages } from "../../controllers/Admin/MarketExecutive/MarketExecutive.controller";
...
marketExecutiveRouter.route('/nominee/update/:id/:nomineeId')
    .patch(MulterFunction('./uploads/marketExecutive/nominee').fields([{ name: "pan_image", maxCount: 1 }, { name: "aadhar_image", maxCount: 1 }, { name: "passbook_image", maxCount: 1 }]), editNominee)
