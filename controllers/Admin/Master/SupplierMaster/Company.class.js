    ...
    this.#Schema = SchemaFunction(
      new mongoose.Schema({
        ...
        inventorySchema: {
          ...
          default: function () {
            if (
              this.company_type === "retailers" ||
              this.company_type === "offlinestores"
            ) {
              return `${this.company_type}_${this.company_name}_${this.parent()
                ._id.toString()
                .slice(-5)}`;
            } else {
              return null;
        ...
        billingSchema: {
          ...
          default: function () {
            if (
              ...
              return `${this.company_type}_billing_${
                this.company_name
              }_${this.parent()._id.toString().slice(-5)}`;
            } else {
              return null;
            }
          },
